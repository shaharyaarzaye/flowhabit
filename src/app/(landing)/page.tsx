        ...
        <div className="rounded-[2rem] bg-card/80 dark:bg-card/60 backdrop-blur-xl border border-border/50 p-5 space-y-4 shadow-2xl shadow-primary/10">
          ...
          <div className="flex gap-1.5 justify-between">
            {days.map((day, i) => (
              <motion.div
                key={day + i}
                className={`flex flex-col items-center gap-1 px-2 py-1.5 rounded-xl text-[10px] font-medium transition-all ${
                  i === 3
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans overflow-x-hidden">
        ...
        <nav className="relative max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 group">
            <span className="text-xl font-display tracking-tight">
              ...
              <span className="font-extrabold text-foreground">Habit</span>
            </span>
          </Link>
            ...
            >
              <div className="p-4 space-y-3">
                ...
                <div className="pt-3 flex flex-col gap-2">
                  <SignedOut>
                    <SignInButton mode="modal">
                      <button className="w-full text-sm font-medium text-muted-foreground hover:text-foreground transition-colors py-2 rounded-xl border border-border/50">
                        Sign In
                      </button>
                    </SignInButton>
                    <SignUpButton mode="modal">
                      <button className="w-full text-sm font-medium bg-gradient-to-r from-primary to-purple-500 text-white py-2.5 rounded-xl">
                        Get Started Free
                      </button>
                    </SignUpButton>
                  </SignedOut>
                  <SignedIn>
                    <Link
                      href="/dashboard"
                      className="w-full text-center text-sm font-medium bg-gradient-to-r from-primary to-purple-500 text-white py-2.5 rounded-xl block"
                    >
                      Dashboard
                    </Link>
                  </SignedIn>
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              >
                The beautifully simple habit tracker that helps you stay
                consistent, build streaks, and achieve your goals — one day at a
                time.
              </motion.p>
              ...
              >
                <div className="flex -space-x-2">
                  {["#818cf8", "#34d399", "#f472b6", "#fbbf24"].map(
                    (color, i) => (
                      <div
                        key={i}
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Powerful features wrapped in a minimal interface. No clutter, no
              distractions — just what you need.
            </p>
          </motion.div>
      ...
      <section
        id="how-it-works"
        className="relative py-24 lg:py-32 bg-card/30 border-y border-border/50"
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Getting started takes less than 30 seconds. No complex setup, no
              learning curve.
            </p>
          </motion.div>
      ...
      <section id="pricing" className="relative py-24 lg:py-32">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Start free. Upgrade once when you&apos;re ready for unlimited
              habits — no subscriptions.
            </p>
          </motion.div>
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-xl mx-auto">
              Join thousands of people who are transforming their daily routines
              with FlowHabit. Start today — it&apos;s free.
            </p>
            <SignedOut>
              <SignUpButton mode="modal">
      ...
      <footer className="border-t border-border/50 bg-card/30 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-sm text-muted-foreground max-w-sm leading-relaxed">
                The minimalist habit tracker designed to help you build
                consistency and transform your daily routines.
              </p>
            </div>
          ...
          <div className="mt-10 pt-6 border-t border-border/50 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <p className="text-xs text-muted-foreground">
              Made with <span className="text-red-400">♥</span> for habit
              builders
            </p>
          </div>
        </div>
