export const Signup = () => {
    return (
      <div className='flex justify-center items-center h-[100vh]'>
        <form action="https://redesigned-fiesta-46xv5jpg465cq4r5-3000.app.github.dev/signup" method="POST" className='border-black border-2 rounded-md flex flex-col p-[2rem] gap-5'>
